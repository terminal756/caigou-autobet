...
;(function (egret) {
  ...
  ;(function (pro) {
    ...
    function createTextureFrom3dScene(scenePath, textureWidth, textureHeight) {
      ...
      return Application.instance.egretProUtil.execute(
        'createTextureFrom3dScene',
        scenePath,
        textureWidth,
        textureHeight
      )
...
;(function (egret) {
  ...
  var KTXContainer = (function () {
    ...
    function KTXContainer(
      /** contents of the KTX container file */ arrayBuffer,
      facesExpected,
      threeDExpected,
...
;(function (egret) {
  ...
  var Capabilities = (function () {
    ...
    Object.defineProperty(Capabilities, 'supportedCompressedTexture', {
      get: function () {
        if (
          this._supportedCompressedTexture &&
          this._supportedCompressedTexture.pvrtc != undefined &&
          this._supportedCompressedTexture != undefined
        ) {
